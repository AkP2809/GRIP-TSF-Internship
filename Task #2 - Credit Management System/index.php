    ...
    <div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
      ...
      <main role="main" class="inner cover">
        ...
        <div class="quote" align="center" style="margin-top:40px;margin-bottom: 20px;">
            <quote style="font-style: italic; font-size: 20px; color: #ffa500;">“Expect the best. Prepare for the worst. Capitalize on what comes.”</quote>
        </div>  
      </main>

      <footer class="mastfoot mt-auto">
        <div class="inner">
          <p>Made with ❤ in 2020 during <a href="https://www.thesparksfoundationsingapore.org/join-us/internship-positions/">#GRIP</a>, for <a href="https://www.thesparksfoundationsingapore.org/">@TSF</a>.</p>
        </div>
      </footer>
    </div>
